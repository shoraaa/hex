...
POLICY_HYPERPARAMETERS: dict[str, tuple[dict[str, Any], ...]] = {
    ...
    "aco": (
        {"key": "ants", "label": "Ant count", "type": "integer", "min": 1, "step": 1},
        {"key": "iterations", "label": "ACO iterations", "type": "integer", "min": 1, "step": 1},
        {"key": "evaporation", "label": "Pheromone retention", "type": "number", "exclusive_min": 0, "exclusive_max": 1, "step": 0.01},
    ),
    "aco_ls": (
        {"key": "ants", "label": "Ant count", "type": "integer", "min": 1, "step": 1},
        {"key": "iterations", "label": "ACO iterations", "type": "integer", "min": 1, "step": 1},
